...
class Login extends Component {
  ...
  handleSubmit = e => {
    ...
    if (email === "" || email === undefined || email === null)
      return swal("Please enter your email", "", "warning");
    if (password === "" || password === undefined || password === null)
      return swal("Please enter your password", "", "warning");
    ...
    return (
      <div className="mt-4 mb-5 container">
        <div className="card mt-5">
          <div className="row">
            <div className="col-lg-5 col-md-6 p-5 mt-2">
              <img
                className="logo"
                src={logo}
                style={{
              ...
              <p style={{ fontSize: "16px" }}>
                To grab an internship that matches your profile.
              </p>
              <br />
              ...
              <form onSubmit={this.handleSubmit}>
                ...
                <button type="submit" className="gbutton btn">
                  Login
                </button>
              </form>
            </div>
        ...
        <div className="mt-5">
          <div className="row">
            ...
            <div className="col-lg-4">
              <img
                src="https://images.pexels.com/photos/450271/pexels-photo-450271.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
                width="100%"
                alt=""
            ...
            <div className="col-lg-4 pt-4">
              <p style={{ fontSize: "20px" }} className="p_classic">
